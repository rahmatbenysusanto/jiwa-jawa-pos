                ...
                <ul class="nav user-menu">
                    ...
                    <li class="nav-item dropdown has-arrow main-drop profile-nav">
                        ...
                        <div class="dropdown-menu menu-drop-user">
                            ...
                            <hr class="my-2">
                            <a class="dropdown-item logout pb-0" href="{{ route('logout') }}"><i
                    ...
                    <ul>
                        <li class="submenu-open">
                            ...
                            <ul>
                                ...
                                <li class="submenu-open mt-2">
                                    ...
                                    <ul>
                                        ...
                                        @if (collect(Session::get('menu', []))->contains('Menu'))
                                            <li
                                                class="{{ in_array($title, ['Menu List', 'Create Menu']) ? 'active' : '' }}">
                                        ...
                                        @if (collect(Session::get('menu', []))->contains('Recipe menu'))
                                            <li class="submenu">
                                                <a href="javascript:void(0);"
                                                    class="{{ in_array($title, ['Recipe Menu', 'Recipe Addon']) ? 'active subdrop' : '' }}">
                                                    <i class="ti ti-book-2 fs-16 me-2"></i>
                                                    <span>Recipe</span>
                                                    <span class="menu-arrow"></span>
                                                </a>
                                                <ul style="display: none;">
                                                    <li><a href="{{ route('menu.recipe.menu') }}"
                                                            class="{{ $title == 'Recipe Menu' ? 'active' : '' }}">Menu</a>
                                                    </li>
                                                    <li><a href="{{ route('menu.recipe.addon') }}"
                                                            class="{{ $title == 'Recipe Addon' ? 'active' : '' }}">Addon</a>
                                                    </li>
                                                </ul>
                                            </li>
                                        @endif
                                ...
                                <li class="submenu-open mt-2">
                                    @if (collect(Session::get('menu', []))->intersect([
                                                'Sales Report',
                                                'Top Selling Menu Report',
                                                'Low Moving Menu Report',
                                                'Stock Report',
                                                'Products Report',
                                    ...
                                    <ul>
                                        <li class="submenu">
                                            <a href="javascript:void(0);"
                                                class="{{ in_array($title, ['Kas', 'Kas Bulanan']) ? 'active subdrop' : '' }}">
                                                <i class="ti ti-chart-bar fs-16 me-2"></i>
                                                <span>Kas Konsolidasi</span>
                                                <span class="menu-arrow"></span>
                                            </a>
                                            <ul style="display: none;">
                                                <li><a href="{{ route('report.kas.konsolidasi') }}"
                                                        class="{{ $title == 'Kas' ? 'active' : '' }}">Harian</a></li>
                                                <li><a href="{{ route('report.kas.konsolidasi.monthly') }}"
                                                        class="{{ $title == 'Kas Bulanan' ? 'active' : '' }}">Bulanan</a>
                                                </li>
                                            </ul>
                                        </li>
                                        ...
                                        @if (collect(Session::get('menu', []))->contains('Sales Report'))
                                            <li class="submenu">
                                                <a href="javascript:void(0);"
                                                    class="{{ in_array($title, ['Sales Report Daily', 'Sales Report Monthly']) ? 'active subdrop' : '' }}">
                                                ...
                                                <ul style="display: none;">
                                                    <li><a href="{{ route('report.sales') }}"
                                                            class="{{ $title == 'Sales Report Daily' ? 'active' : '' }}">Daily</a>
                                                    </li>
                                                    <li><a href="{{ route('report.sales.monthly') }}"
                                                            class="{{ $title == 'Sales Report Monthly' ? 'active' : '' }}">Monthly</a>
                                                    </li>
                                                </ul>
                                            </li>
                                        @endif
