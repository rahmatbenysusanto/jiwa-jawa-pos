    ...
    <div class="page-header">
        ...
        <div class="page-btn">
            @if (collect(Session::get('menu', []))->contains('Add Menu Category'))
                <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add-category"><i
            ...
            <div class="d-flex justify-content-end mt-3">
                @if ($category->hasPages())
                    <ul class="pagination">
                        ...
                        @else
                            <li><a href="{{ $category->previousPageUrl() }}&per_page={{ request('per_page', 10) }}"
                        ...
                        @if ($category->hasMorePages())
                            <li><a href="{{ $category->nextPageUrl() }}&per_page={{ request('per_page', 10) }}"
