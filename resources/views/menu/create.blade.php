            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" name="hpp" id="hpp" placeholder="Rp ...">
                    </div>
                    <div class="mb-3">
                    ...
                    htmlOption += `
                        <div class="row mb-3">
                            ...
                            <div class="col-3">
                                ...
                                <input type="number" class="form-control" value="${option.hpp}" placeholder="Rp ..." oninput="changeOption(${indexVariant}, ${indexOption}, 'hpp', this.value)">
                            </div>
                            <div class="col-3">
