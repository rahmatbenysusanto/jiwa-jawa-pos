...
@section('js')
    ...
    <script>
            ...
            if (cart === []) {
                ...
                cart.forEach((item, index) => {
                    ...
                    if (parseInt(item.priceDiscount) === 0) {
                        ...
                        price = `
                            <div class="text-decoration-line-through">Rp ${rupiah(parseInt(item.basePrice + item.priceDelta + item.priceAddon) * item.qty)}</div>
        ...
        function calculatePrice() {
            ...
            cart.forEach((item) => {
                subTotal += (item.basePrice + item.priceDelta + item.priceAddon) * item.qty;
